...
function Sidebar() {
    ...
    return (
        <div className='p-4 bg-[#f5f5f5] h-screen relative'>
            ...
            <div className='mt-4 text-sm px-6 font-semibold flex-col flex justify-between'>
                <ul className='space-y-1'>
                    ...
                    <Link href="/Abiso" className={`hover:bg-gray-50 hover:text-blue-500 rounded-3xl  flex items-center p-4 gap-2 ${pathname === "/Abiso" ? "text-blue-500 bg-gray-50" : "text-[#121212]"}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                    ...
                    <Link href="/Users" className={`hover:bg-gray-50 hover:text-blue-500 rounded-3xl  flex items-center p-4 gap-2 ${pathname === "/Users" ? "text-blue-500 bg-gray-50" : "text-[#121212]"}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                ...
                <p className='mt-4 text-xs absolute bottom-5 text-[#121212]'>© 2024 Abiso IVC. All rights reserved.</p>
            </div>
        </div>
    )
}
